...
const CheckoutModal = ({ isOpen, onClose, onSubmit, product }) => {
  ...
  return (
    <div className='fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4'>
      <div className='bg-white rounded-none-xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto'>
        {/* Header */}
        <div className='p-6 border-b border-gray-200 flex items-center justify-between bg-gradient-to-r from-orange-400 to-orange-500 rounded-none-t-xl'>
          <div>
        ...
        <div className='p-4 bg-gray-50 border-b border-gray-200'>
          <div className='flex items-center space-x-4'>
            {product && (
              <>
                <div className='h-20 w-20 flex-shrink-0 overflow-hidden rounded-none-lg border-2 border-orange-100 bg-white shadow-sm'>
                  <img
                    src={
                ...
                <div className='flex-1'>
                  ...
                  <div className='flex items-center justify-between mt-1'>
                    ...
                    <span className='bg-orange-100 text-orange-800 text-xs font-medium px-2 py-0.5 rounded-none'>
                      1 item
                    </span>
                  </div>
                </div>
          ...
          <div className='space-y-5'>
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className='block w-full rounded-none-lg border border-gray-300 px-4 py-2.5 text-sm shadow-sm focus:border-orange-500 focus:ring-2 focus:ring-orange-200'
